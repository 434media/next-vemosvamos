          ...
          <div className="w-full max-w-md mx-auto space-y-12">
            ...
            >
              ...
              >
                ...
                />
                <div className="relative bg-black/20 backdrop-blur-sm rounded-lg p-6 border border-white/10">
            ...
            >
              ...
              <div className="flex justify-center space-x-8">
                {socialLinks.map((link, index) => (
                  ...
                  >
                    <motion.div
                      className="relative flex items-center justify-center w-16 h-16 rounded-full bg-white/10 backdrop-blur-sm border border-white/20"
                      whileHover={{
                    ...
                    >
                      ...
                      <motion.div
                        className="absolute -top-2 -right-2 text-[#8b0000] text-xs"
                        animate={{
                          y: [0, -10, 0],
                          rotate: [0, 15, 0],
                          scale: [1, 1.2, 1],
                    ...
                    <span className="text-sm font-medium mt-2 group-hover:text-white transition-colors">
                      {link.name}
                    </span>
                  </motion.a>
                ))}
