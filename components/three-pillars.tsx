...
export default function WhoWeReach() {
  ...
  return (
    <section
      ref={sectionRef}
      className="xs:-mt-13 md:-mt-1 relative w-full bg-[#ca0013] flex flex-col items-center xs:justify-center justify-start text-white overflow-hidden z-30 min-h-[24vh] xs::min-h-22vh sm:min-h-[27vh] md:min-h-[70vh] lg:min-h-[75vh] xl:min-h-[80vh] py-4 sm:py-6 md:py-12 lg:py-16 xl:py-20"
