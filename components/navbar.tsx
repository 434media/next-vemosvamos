      ...
      >
        <nav className="container mx-auto px-4">
          <div className="flex justify-between items-center h-[80px] md:h-[76px]">
            ...
            >
              <motion.div
                className="absolute inset-0 rounded-full p-[2px] bg-gradient-to-r from-[#8b0000] via-[#ffc857] to-[#8b0000]"
                animate={{
                  rotate: [0, 360],
                }}
                transition={{
              ...
              <motion.div
                className="absolute inset-0 rounded-full border-2 border-[#8b0000]/30 z-20"
              ...
              {/* Hover ring effect */}
              <motion.div
                className="absolute inset-0 rounded-full border-2 border-[#ffc857] opacity-0 z-20"
                whileHover={{
                  scale: [1, 1.3, 1.1],
                  opacity: [0, 0.8, 0.4],
