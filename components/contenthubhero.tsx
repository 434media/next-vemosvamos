    ...
    <div className="relative w-full overflow-hidden pt-10 md:pt-0">
      ...
      <section className="relative xs:h-[60vh] h-[78vh] md:h-screen w-full bg-[#eeebe3] pt-32 md:pt-16 flex">
        ...
        <div className="relative w-full mx-auto px-4 md:px-6 flex flex-col md:flex-row h-full max-w-none">
          ...
          <motion.div
            className="absolute bottom-8 right-8 md:bottom-12 md:right-12 z-20 xs:-right-20 xs:-bottom-10"
            initial={{
              opacity: 0,
              x: 200,
              y: 0,
          ...
          >
            <Image
              ...
              width={400}
              height={400}
              className="w-80 h-80 xs:w-80 xs:h-80 md:w-[28rem] md:h-[28rem] lg:w-[32rem] lg:h-[32rem] drop-shadow-lg object-contain xs:object-contain md:object-cover"
            />
          </motion.div>
        </div>
      </section>
